...
class MinHeap {
  ...
  extract() {
    ...
    [this.heap[currentIndex], this.heap[this.size()]] = [this.heap[this.size()], this.heap[currentIndex]];
    this.heap.pop();

    // define all variables
    // find small index
    let smallIdx = 1;
    let leftIdx = currentIndex * 2;
    let rightIdx = (currentIndex * 2) + 1;

    // find which child is the smallest
    ...
    while (this.heap[currentIndex] > this.heap[smallIdx]) {
      // ...
      console.log("parent:", this.heap[currentIndex]);
      console.log("smallest child:", this.heap[smallIdx]);
      console.log("===============");

      // swap

      // re assign the parent (current index)
